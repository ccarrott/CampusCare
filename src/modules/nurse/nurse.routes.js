...
import { requirePatientRelationship } from '../../middleware/ownership.js';
...
// Teams link
router.post('/update-teams-link', requireRole(ROLES.NURSE), NurseController.updateTeamsLink);

// Appointment status + notes
router.post('/appointment/status', requireRole(ROLES.NURSE), NurseController.changeAppointmentStatus);
router.post('/appointment/notes', requireRole(ROLES.NURSE), NurseController.saveAppointmentNotes);
