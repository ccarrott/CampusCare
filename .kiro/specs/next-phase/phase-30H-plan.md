...
4. **Micro-interactions:** button sheen on press, card hover-lift consistency, toast entrance, progress-bar spring, identity-chip open. All via tokens/Motion One, reduced-motion safe.
