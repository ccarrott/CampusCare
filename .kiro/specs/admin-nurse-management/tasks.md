# Tasks: Nurse & Admin Management

## Completed
- [x] Task 1: Build `nurseManagementModel.js` and `adminReportModel.js`.
- [x] Task 2: Implement `nurseController.js` for schedule and Teams link updates.
- [x] Task 3: Implement `adminController.js` for aggregate metric report rendering.
- [x] Task 4: Define `managementRoutes.js` with `requireNurse` and `requireAdmin` middlewares.
- [x] Task 5: Build EJS UI dashboards (`views/nurse/dashboard.ejs` and `views/admin/reports.ejs`).
